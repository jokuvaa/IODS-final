---
title: "index.Rmd"
author: "Mika Tapio Vehka"
date: "11 joulukuuta 2017"
email: "mika.vehka@helsinki.fi"
...
According to the last model, indus (proportion of non-retail business acres), dis (weighted mean of distances to five Boston employment centres), tax (full-value property-tax rate), black (proportion of blacks) and lstat (lower status of the population) seem to have s statistically significant relationship with crim (per capita crime rate) (p-value better than 0.05). This is very much consistent with the two earlier models.

More non-retail business activities seems to be related to less criminality, which is quite understandable. Distance to employment centers seem to be negatively related, contrary to what was expected. Tax rate seems to be positively related. Contrary to what was expected, the proportion of blacks seems to be negatively related to criminality.This could be due to very small variance of the variable. Lower status of the population seems to be positively related, as expected.
